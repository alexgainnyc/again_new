...
var Manager = angular.module('manager', ['manager.filters', 'manager.services', 'manager.directives', 'manager.controllers', 'restangular', 'ngCookies']) //, 'jdUpload', 'ngRoute'
	...
	.run(['$rootScope', '$location', '$http', '$routeParams', 'Restangular', '$templateCache', function($rootScope, $location, $http, $routeParams, Restangular, $templateCache){
		...
		$rootScope.fieldGridClass = function (field) {
			return "pure-u-1-" + field.editSize;
		};
